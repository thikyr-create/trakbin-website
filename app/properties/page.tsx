...
export default function PropertiesPage() {
  return (
    <>
      <PageHero eyebrow="For properties & caretakers" title="Your building, connected to the network."
      ...
      <Section tone="tint">
        <Container className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <SectionHead eyebrow="Customer dashboard" title="Clarity for residents and caretakers."
